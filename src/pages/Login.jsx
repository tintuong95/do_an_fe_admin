    ...
    <div className="flex justify-center items-center h-screen bg-login ">
      ...
      >
        ...
        <div className="flex flex-col mb-6">
          ...
          <div className="">
            <input
              className="bg-gray-200 text-lg  border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
              id="inline-full-name"
              type="text"
